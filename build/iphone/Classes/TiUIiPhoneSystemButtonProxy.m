...
MAKE_SYSTEM_PROP(ACTIVITY,UIForRentInitialAlloyProjectNativeItemSpinner);
MAKE_SYSTEM_PROP(SPINNER,UIForRentInitialAlloyProjectNativeItemSpinner);
MAKE_SYSTEM_PROP(INFO_LIGHT,UIForRentInitialAlloyProjectNativeItemInfoLight);
MAKE_SYSTEM_PROP(INFO_DARK,UIForRentInitialAlloyProjectNativeItemInfoDark);
MAKE_SYSTEM_PROP(DISCLOSURE,UIForRentInitialAlloyProjectNativeItemDisclosure);
MAKE_SYSTEM_PROP(CONTACT_ADD,UIForRentInitialAlloyProjectNativeItemContactAdd);
