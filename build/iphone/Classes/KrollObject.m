...
//@interface ForRentInitialAlloyProjectObject : NSObject
//@end

@interface ForRentInitialAlloyProjectObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[ForRentInitialAlloyProjectObject class]])
		{
			for (NSString *key in [[(ForRentInitialAlloyProjectObject*)o modules] allKeys])
			{
