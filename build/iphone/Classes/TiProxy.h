...
//Rare exceptions to indicate a bug in the _forrentinitialalloyproject code (Eg, function that a subclass should have implemented)
...
/**
 The base class for ForRentInitialAlloyProject proxies.
 */
