...
// in simulator we redefine to format for ForRentInitialAlloyProject Developer console
...
{\
	NSString * exceptionName = [@"org.forrentinitialalloyproject." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.forrentinitialalloyproject";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIForRentInitialAlloyProjectNativeItemNone = -1, 
	UIForRentInitialAlloyProjectNativeItemSpinner = -2,
	UIForRentInitialAlloyProjectNativeItemProgressBar = -3,
	
	UIForRentInitialAlloyProjectNativeItemSlider = -4,
	UIForRentInitialAlloyProjectNativeItemSwitch = -5,
	UIForRentInitialAlloyProjectNativeItemMultiButton = -6,
	UIForRentInitialAlloyProjectNativeItemSegmented = -7,
	
	UIForRentInitialAlloyProjectNativeItemTextView = -8,
	UIForRentInitialAlloyProjectNativeItemTextField = -9,
	UIForRentInitialAlloyProjectNativeItemSearchBar = -10,
	
	UIForRentInitialAlloyProjectNativeItemPicker = -11,
	UIForRentInitialAlloyProjectNativeItemDatePicker = -12,
	
	UIForRentInitialAlloyProjectNativeItemInfoLight = -13,
	UIForRentInitialAlloyProjectNativeItemInfoDark = -14,
	
	UIForRentInitialAlloyProjectNativeItemDisclosure = -15,
	
	UIForRentInitialAlloyProjectNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all ForRentInitialAlloyProject instances of
