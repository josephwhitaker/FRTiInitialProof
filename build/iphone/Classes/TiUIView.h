...
/**
 Base class for all ForRentInitialAlloyProject views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the ForRentInitialAlloyProject view hierarchy (such as wrapped iOS UIViews) was touched.
