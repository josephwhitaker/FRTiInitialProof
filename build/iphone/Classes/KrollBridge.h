...
@interface ForRentInitialAlloyProjectObject : KrollCoverageObject {
#else
@interface ForRentInitialAlloyProjectObject : KrollObject {
#endif
@private
...
extern NSString * ForRentInitialAlloyProject$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	ForRentInitialAlloyProjectObject *_forrentinitialalloyproject;
    KrollObject* console;
	BOOL shutdown;
